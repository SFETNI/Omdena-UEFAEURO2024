...
def get_action_vector(shot_heatmap: np.array, pass_heatmap: np.array, dribble_heatmap: np.array,
                      cross_heatmap: np.array, player_column_index: int) -> np.array:
    ...
    return np.concat([shot_vector, pass_vector, cross_vector, dribble_vector])
...
def calculate_mahattan_distance(row, unique_player_ids, shot_action_heatmap_H,
...
if __name__ == "__main__":
    ...
    df_manhattan_distance["distance"] = df_manhattan_distance.apply(calculate_mahattan_distance, axis=1, args=(
        unique_player_ids, shot_action_heatmap_H, pass_action_heatmap_H, dribble_action_heatmap_H, cross_action_heatmap_H))
